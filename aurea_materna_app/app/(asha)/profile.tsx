...
export default function AshaProfile() {
  ...
  const [name, setName] = useState(ashaData.name);
  const [mobile, setMobile] = useState("+91 98765 11111");
  const [panchayat, setPanchayat] = useState(ashaData.panchayat);
  
  // Settings state
  const [newMotherAlert, setNewMotherAlert] = useState(true);
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>ASHA Profile</Text>
        <View style={{ width: 24 }} />
      </View>
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.settingsSection}>
          ...
          <View style={styles.card}>
            <PrefRow label="New mother assigned" value={newMotherAlert} onValueChange={setNewMotherAlert} />
            <PrefRow label="Emergency alerts (Red)" value={emergencyAlert} onValueChange={setEmergencyAlert} />
            <PrefRow label="Daily sync reminder" value={dailySync} onValueChange={setDailySync} isLast />
          </View>
