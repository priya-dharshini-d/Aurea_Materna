...
export default function DoctorProfile() {
  ...
  const [name, setName] = useState("Dr. Ananya R.");
  const [mobile, setMobile] = useState("+91 98765 22222");
  const [phcName, setPhcName] = useState("PHC Coimbatore");
  
  // Settings state
  const [highRiskAlerts, setHighRiskAlerts] = useState(true);
  const [escalationReqs, setEscalationReqs] = useState(true);
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.settingsSection}>
          ...
          <View style={styles.card}>
            <PrefRow label="High-risk patient alerts" value={highRiskAlerts} onValueChange={setHighRiskAlerts} />
            <PrefRow label="ASHA escalations" value={escalationReqs} onValueChange={setEscalationReqs} />
            <PrefRow label="Weekly summary report" value={weeklyReports} onValueChange={setWeeklyReports} isLast />
          </View>
